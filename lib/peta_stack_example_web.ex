defmodule PetaStackExampleWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PetaStackExampleWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/peta_stack_example_web/templates",
        namespace: PetaStackExampleWeb
  ...
  defp view_helpers do
    quote do
      ...
      import PetaStackExampleWeb.ErrorHelpers
      import PetaStackExampleWeb.Gettext
      alias PetaStackExampleWeb.Router.Helpers, as: Routes
    end
  end
